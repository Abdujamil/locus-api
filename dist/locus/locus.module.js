...
const locus_member_entity_1 = require("./entities/locus-member.entity");
let LocusModule = class LocusModule {
};
exports.LocusModule = LocusModule;
exports.LocusModule = LocusModule = __decorate([
    (0, common_1.Module)({
        imports: [typeorm_1.TypeOrmModule.forFeature([locus_entity_1.RncLocus, locus_member_entity_1.RncLocusMember])],
